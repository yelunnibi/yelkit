...
public extension UIView {
    @IBInspectable var p_cornerRadius: CGFloat {
        get {
    ...
    @IBInspectable var p_borderWidth: CGFloat {
        get {
    ...
    @IBInspectable var p_borderColor: UIColor {
        get {
    ...
    @IBInspectable var p_shadowColor: UIColor? {
        get {
    ...
    @IBInspectable var p_shadowOpacity: Float {
        get {
    ...
    @IBInspectable var p_shadowOffset: CGSize {
        get
        {
    ...
    @IBInspectable var p_shadowRadius: CGFloat {
        get
        {
    ...
    @IBInspectable var p_rotation: CGFloat {
        get
        {
            return 1.0
        }
